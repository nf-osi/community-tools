...
ASSOCIATION ENGINE (params.engine = "plink" or "saige"): preserve the user's choice in resolved_context.params.engine. PLINK2 --glm is fine for unrelated samples with balanced or quantitative traits. SAIGE is a mixed model with saddlepoint/Firth correction — recommend it (via a needs_input question or an appropriateness warning) when you detect small or imbalanced case/control counts or likely sample relatedness, since PLINK's p-values are unreliable there.
